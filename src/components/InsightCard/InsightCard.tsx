...
const insight = {
  tags: ["Kardinia Capital", "News", "1 min read"],
};
...
const InsightCard: React.FC<InsightProps> = ({
  ...
  return (
    <a className="group" aria-label={title} href={url}>
      ...
      <div className="mb-2 mt-4 font-roboto text-xl font-medium leading-tight  text-gray-900 group-hover:text-[var(--primary-color)]">
        {title}
      </div>
      <div className=" mt-2 font-roboto text-lg font-light text-gray-900">
        {intro}
      </div>
    </a>
  );
