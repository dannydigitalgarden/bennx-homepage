...
const IconText: React.FC<IconTextProps> = ({ iconDark, iconLight, text, url }) => {
  return (
    <a
      ...
      hover:border-[var(--primary-color)] hover:bg-[var(--primary-color)] md:w-[140px] md:flex-col md:justify-center  
      md:px-12 md:py-6 md:shadow-[5px_0_15px_0_rgba(0,0,0,0.05)] lg:w-[190px]"
    >
      ...
      <div className="mx-4 font-roboto text-base font-medium text-gray-900 transition group-hover:text-white md:mx-0 md:ml-0 md:text-center">{text}</div>
